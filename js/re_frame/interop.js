...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__1140 = cljs.core.instance_QMARK_;
var expr__1141 = reactive_val;
if(cljs.core.truth_(pred__1140.call(null,reagent.ratom.RAtom,expr__1141))){
return "ra";
} else {
if(cljs.core.truth_(pred__1140.call(null,reagent.ratom.RCursor,expr__1141))){
return "rc";
} else {
if(cljs.core.truth_(pred__1140.call(null,reagent.ratom.Reaction,expr__1141))){
return "rx";
} else {
if(cljs.core.truth_(pred__1140.call(null,reagent.ratom.Track,expr__1141))){
return "tr";
} else {
return "other";
}
