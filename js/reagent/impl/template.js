...
var G__4153 = o;
(G__4153[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__4155__i = 0, G__4155__a = new Array(arguments.length -  0);
while (G__4155__i < G__4155__a.length) {G__4155__a[G__4155__i] = arguments[G__4155__i + 0]; ++G__4155__i;}
  args = new cljs.core.IndexedSeq(G__4155__a,0,null);
} 
return G__4154__delegate.call(this,args);};
G__4154.cljs$lang$maxFixedArity = 0;
G__4154.cljs$lang$applyTo = (function (arglist__4156){
var args = cljs.core.seq(arglist__4156);
return G__4154__delegate(args);
});
...
var G__4157 = o;
(G__4157[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var G__4162 = props;
var G__4162__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__4162,cljs.core.cst$kw$id,id):G__4162);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__4162__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__4163){
var map__4164 = p__4163;
var map__4164__$1 = (((((!((map__4164 == null))))?(((((map__4164.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4164.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__4164):map__4164);
var props = map__4164__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4164__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__4164,map__4164__$1,props,class$){
return (function (c){
...
});})(map__4164,map__4164__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__4166){
var map__4167 = p__4166;
var map__4167__$1 = (((((!((map__4167 == null))))?(((((map__4167.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__4167.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__4167):map__4167);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__4167__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__4167,map__4167__$1,on_write){
return (function (){
...
});})(node_value,map__4167,map__4167__$1,on_write))
);
} else {
...
var G__4170 = jsprops;
(G__4170["defaultValue"] = value);

(G__4170["onChange"] = ((function (G__4170,v,value,on_change){
return (function (p1__4169_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__4169_SHARP_);
});})(G__4170,v,value,on_change))
);
...
var vec__4173 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4173,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4173,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4173,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___4177 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___4177 == null)){
} else {
var key_4178 = temp__5724__auto___4177;
(jsprops["key"] = key_4178);
}
...
var temp__5724__auto___4179 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___4179 == null)){
} else {
var key_4180 = temp__5724__auto___4179;
reagent.impl.template.oset(jsprops,"key",key_4180);
}
...
var G__4181 = reagent.impl.template.__GT_NativeWrapper();
(G__4181["name"] = c);
...
var G__4182 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__4182) : reagent.impl.template.as_element.call(null,G__4182));
} else {
...
var len__4730__auto___4188 = arguments.length;
var i__4731__auto___4189 = (0);
while(true){
if((i__4731__auto___4189 < len__4730__auto___4188)){
args__4736__auto__.push((arguments[i__4731__auto___4189]));

var G__4190 = (i__4731__auto___4189 + (1));
i__4731__auto___4189 = G__4190;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq4186){
var G__4187 = cljs.core.first(seq4186);
var seq4186__$1 = cljs.core.next(seq4186);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__4187,seq4186__$1);
});
...
break;
default:
var G__4193 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__4193;
continue;
...
var n__4607__auto___4195 = a.length;
var i_4196 = (0);
while(true){
if((i_4196 < n__4607__auto___4195)){
(a[i_4196] = reagent.impl.template.as_element((a[i_4196])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___4198 = a.length;
var i_4199 = (0);
while(true){
if((i_4199 < n__4607__auto___4198)){
var val_4200 = (a[i_4199]);
if(((cljs.core.vector_QMARK_(val_4200)) && ((reagent.impl.template.key_from_vec(val_4200) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_4199] = reagent.impl.template.as_element(val_4200));

var G__4201 = (i_4199 + (1));
i_4199 = G__4201;
continue;
} else {
}
...
var ctx = ({});
var vec__4202 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4202,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__4202,(1),null);
...
var G__4205 = (cljs.core.count(argv) - first_child);
switch (G__4205) {
case (0):
...
var G__4206 = comp;
var G__4207 = jsprops;
var G__4208 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__4206,G__4207,G__4208) : reagent.impl.template.global$module$react.createElement.call(null,G__4206,G__4207,G__4208));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__4205){
