...
if((i < len)){
var k = (ks[i]);
var G__4583 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__4584 = (i + (1));
m = G__4583;
i = G__4584;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__4585 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__4585) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__4585));
})());
} else {
var v = temp__5459__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__4587 = c;
var G__4587__$1 = (((G__4587 == null))?null:G__4587.prototype);
if((G__4587__$1 == null)){
return null;
} else {
return (G__4587__$1["reagentRender"]);
}
})() == null))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && (!(((function (){var G__4589 = c;
var G__4589__$1 = (((G__4589 == null))?null:G__4589.prototype);
if((G__4589__$1 == null)){
return null;
} else {
return (G__4589__$1["render"]);
}
})() == null))));
});
...
var G__4591 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__4591) : reagent.impl.component.as_element.call(null,G__4591));
};
...
while (G__4594__i < G__4594__a.length) {G__4594__a[G__4594__i] = arguments[G__4594__i + 0]; ++G__4594__i;}
  args = new cljs.core.IndexedSeq(G__4594__a,0,null);
} 
...
var _STAR_current_component_STAR_4597 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_4597;
}});
...
var G__4598 = key;
var G__4598__$1 = (((G__4598 instanceof cljs.core.Keyword))?G__4598.fqn:null);
switch (G__4598__$1) {
...
return ((function (G__4598,G__4598__$1){
...
var c = this;
var G__4603_4605 = (c["cljsRatom"]);
if((G__4603_4605 == null)){
} else {
reagent.ratom.dispose_BANG_(G__4603_4605);
}
...
var renders_4607 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_4608 = cljs.core.first(cljs.core.vals(renders_4607));
if((cljs.core.count(renders_4607) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_4607))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_4608)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_4608], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__4606 = name;
switch (G__4606) {
case "":
...
var G__4611 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__4611) : reagent.impl.component.global$module$create_react_class.call(null,G__4611));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__4612 = fiber;
var G__4612__$1 = (((G__4612 == null))?null:(G__4612["type"]));
if((G__4612__$1 == null)){
return null;
} else {
return (G__4612__$1["displayName"]);
}
})();
var parent = (function (){var G__4613 = fiber;
if((G__4613 == null)){
return null;
} else {
return (G__4613["return"]);
}
})();
var path = (function (){var G__4614 = parent;
var G__4614__$1 = (((G__4614 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__4614) : reagent.impl.component.fiber_component_path.call(null,G__4614)));
if((G__4614__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__4614__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__3949__auto__ = (function (){var G__4616 = c;
if((G__4616 == null)){
return null;
} else {
return (G__4616["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__4617._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__3949__auto__ = (function (){var G__4619 = c;
if((G__4619 == null)){
return null;
} else {
return (G__4619["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var or__3949__auto____$1 = (function (){var G__4621 = c;
if((G__4621 == null)){
return null;
} else {
return G__4621._reactInternalInstance;
}
})();
...
var elem = (function (){var or__3949__auto__ = (function (){var G__4623 = instance;
if((G__4623 == null)){
return null;
} else {
return (G__4623["_currentElement"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
} else {
var G__4624 = instance;
if((G__4624 == null)){
return null;
} else {
return G__4624._currentElement;
}
}
})();
var name = (function (){var G__4625 = elem;
var G__4625__$1 = (((G__4625 == null))?null:(G__4625["type"]));
if((G__4625__$1 == null)){
return null;
} else {
return (G__4625__$1["displayName"]);
}
})();
var owner = (function (){var or__3949__auto__ = (function (){var G__4627 = elem;
if((G__4627 == null)){
return null;
} else {
return (G__4627["_owner"]);
}
})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
return G__4628._owner;
}
}
})();
var path = (function (){var G__4629 = owner;
var G__4629__$1 = (((G__4629 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__4629) : reagent.impl.component.component_path.call(null,G__4629)));
if((G__4629__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__4629__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__4630 = c;
var G__4630__$1 = (((G__4630 == null))?null:G__4630.constructor);
if((G__4630__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__4630__$1);
}
}
})();
