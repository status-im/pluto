...
pluto.storage.ipfs.IPFSStorage.prototype.pluto$storage$Storage$fetch$arity$3 = (function (_,p__7419,callback){
var self__ = this;
var map__7420 = p__7419;
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7420__$1,cljs.core.cst$kw$value);
var ___$1 = this;
...
return xhr.onreadystatechange = ((function (xhr,___$1,map__7420,map__7420__$1,value){
return (function (){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(xhr.readyState,(4))){
var G__7422 = pluto.storage.ipfs.result(xhr);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__7422) : callback.call(null,G__7422));
} else {
return null;
}
});})(xhr,___$1,map__7420,map__7420__$1,value))
;
});
