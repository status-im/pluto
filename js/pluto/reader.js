...
var G__1441 = cljs.core.name(s);
return (keys.cljs$core$IFn$_invoke$arity$1 ? keys.cljs$core$IFn$_invoke$arity$1(G__1441) : keys.call(null,G__1441));
});
...
var hierarchy__4528__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$hierarchy,(function (){var fexpr__1442 = cljs.core.get_global_hierarchy;
return (fexpr__1442.cljs$core$IFn$_invoke$arity$0 ? fexpr__1442.cljs$core$IFn$_invoke$arity$0() : fexpr__1442.call(null));
})());
...
pluto.reader.valid_element_QMARK_.cljs$core$IMultiFn$_add_method$arity$3(null,"hooks",(function (p__1444,k,v){
...
var hooks = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1445__$1,cljs.core.cst$kw$hooks);
...
pluto.reader.valid_element_QMARK_.cljs$core$IMultiFn$_add_method$arity$3(null,"queries",(function (p__1447,k,v){
...
var queries = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1448__$1,cljs.core.cst$kw$queries);
return null;
}));
pluto.reader.valid_element_QMARK_.cljs$core$IMultiFn$_add_method$arity$3(null,"events",(function (p__1450,k,v){
...
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1451__$1,cljs.core.cst$kw$events);
return null;
}));
pluto.reader.valid_element_QMARK_.cljs$core$IMultiFn$_add_method$arity$3(null,"events",(function (p__1453,k,v){
var map__1454 = p__1453;
...
var events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1454__$1,cljs.core.cst$kw$events);
return null;
}));
pluto.reader.valid_element_QMARK_.cljs$core$IMultiFn$_add_method$arity$3(null,"views",(function (p__1456,k,_){
...
var components = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1457__$1,cljs.core.cst$kw$components);
if(cljs.core.truth_((function (){var G__1460 = cljs.core.name(k);
var fexpr__1459 = cljs.core.set(cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.keys(components)));
return (fexpr__1459.cljs$core$IFn$_invoke$arity$1 ? fexpr__1459.cljs$core$IFn$_invoke$arity$1(G__1460) : fexpr__1459.call(null,G__1460));
})())){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.reader.errors.error.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pluto$reader$errors_SLASH_invalid_DASH_key,k)], null);
} else {
return null;
...
pluto.reader.validate = (function pluto$reader$validate(p__1464,m){
var map__1465 = p__1464;
...
var capacities = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1465__$1,cljs.core.cst$kw$capacities);
...
return cljs.core.reduce_kv(((function (keys,missing_keys,map__1465,map__1465__$1,capacities){
return (function (p1__1463_SHARP_,p2__1461_SHARP_,p3__1462_SHARP_){
var temp__5718__auto__ = (pluto.reader.valid_element_QMARK_.cljs$core$IFn$_invoke$arity$3 ? pluto.reader.valid_element_QMARK_.cljs$core$IFn$_invoke$arity$3(capacities,p2__1461_SHARP_,p3__1462_SHARP_) : pluto.reader.valid_element_QMARK_.call(null,capacities,p2__1461_SHARP_,p3__1462_SHARP_));
if(cljs.core.truth_(temp__5718__auto__)){
var errors = temp__5718__auto__;
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(p1__1463_SHARP_,errors);
} else {
return p1__1463_SHARP_;
}
});})(keys,missing_keys,map__1465,map__1465__$1,capacities))
...
return pluto.reader.errors.merge_results.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([pluto.reader.parse_meta((function (){var fexpr__1467 = cljs.core.cst$sym$meta;
return (fexpr__1467.cljs$core$IFn$_invoke$arity$1 ? fexpr__1467.cljs$core$IFn$_invoke$arity$1(m) : fexpr__1467.call(null,m));
