 ...
 */
pluto.reader.reference.resolve_symbol = (function pluto$reader$reference$resolve_symbol(ctx,ext,ns,s){
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ctx,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$capacities,cljs.core.cst$kw$components,s,cljs.core.cst$kw$value], null));
}
});
/**
...
var temp__5455__auto____$2 = pluto.reader.reference.resolve_symbol(ctx,ext,ns,s);
