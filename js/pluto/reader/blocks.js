...
var hierarchy__4528__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$hierarchy,(function (){var fexpr__1253 = cljs.core.get_global_hierarchy;
return (fexpr__1253.cljs$core$IFn$_invoke$arity$0 ? fexpr__1253.cljs$core$IFn$_invoke$arity$0() : fexpr__1253.call(null));
})());
...
return (function (ctx,ext,p__1254){
var vec__1255 = p__1254;
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1255,(0),null);
return type;
...
return clojure.walk.prewalk((function (p1__1258_SHARP_){
var or__4047__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(m,p1__1258_SHARP_);
...
var G__1259 = (function (){var G__1260 = pluto.reader.blocks.substitute_query_values(env,v);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__1260) : re_frame.core.subscribe.call(null,G__1260));
})();
if((G__1259 == null)){
return null;
} else {
return cljs.core.deref(G__1259);
}
} else {
return v;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__1261_SHARP_,p2__1262_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(pluto.reader.blocks.resolve_binding,p1__1261_SHARP_,p2__1262_SHARP_);
...
var G__1264 = p1__1263_SHARP_;
var G__1265 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(values,cljs.core.cst$kw$pluto$reader_SLASH_properties);
return (o.cljs$core$IFn$_invoke$arity$2 ? o.cljs$core$IFn$_invoke$arity$2(G__1264,G__1265) : o.call(null,G__1264,G__1265));
});
} else {
return o;
...
pluto.reader.blocks.let_block = (function pluto$reader$blocks$let_block(p__1268,children){
...
var prev_env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1269__$1,cljs.core.cst$kw$prev_DASH_env);
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1269__$1,cljs.core.cst$kw$bindings);
var new_env = pluto.reader.blocks.resolve_bindings_into(prev_env,bindings);
return pluto.reader.blocks.walkup_upto_leaf(((function (new_env,map__1269,map__1269__$1,prev_env,bindings){
return (function (p1__1266_SHARP_){
return pluto.reader.blocks.replace_atom(new_env,p1__1266_SHARP_);
});})(new_env,map__1269,map__1269__$1,prev_env,bindings))
,((function (new_env,map__1269,map__1269__$1,prev_env,bindings){
return (function (p1__1267_SHARP_){
var and__4036__auto__ = cljs.core.vector_QMARK_(p1__1267_SHARP_);
if(and__4036__auto__){
var G__1274 = cljs.core.first(p1__1267_SHARP_);
var fexpr__1273 = cljs.core.PersistentHashSet.createAsIfByAssoc([pluto.reader.blocks.for_block,pluto.reader.blocks.let_block]);
return (fexpr__1273.cljs$core$IFn$_invoke$arity$1 ? fexpr__1273.cljs$core$IFn$_invoke$arity$1(G__1274) : fexpr__1273.call(null,G__1274));
} else {
return and__4036__auto__;
}
});})(new_env,map__1269,map__1269__$1,prev_env,bindings))
,((function (new_env,map__1269,map__1269__$1,prev_env,bindings){
return (function (p__1275){
var vec__1276 = p__1275;
var x = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1276,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1276,(1),null);
var children__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1276,(2),null);
...
pluto.reader.blocks.for_block = (function pluto$reader$blocks$for_block(p__1279,children){
...
var wrapper_component = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1280__$1,cljs.core.cst$kw$wrapper_DASH_component);
var prev_env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1280__$1,cljs.core.cst$kw$prev_DASH_env);
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1280__$1,cljs.core.cst$kw$bindings);
var vec__1282 = bindings;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1282,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1282,(1),null);
var for_values = pluto.reader.blocks.resolve_rhs(prev_env,v);
if(cljs.core.sequential_QMARK_(for_values)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [wrapper_component,cljs.core.PersistentArrayMap.EMPTY], null),(function (){var iter__4434__auto__ = ((function (vec__1282,k,v,for_values,map__1280,map__1280__$1,wrapper_component,prev_env,bindings){
return (function pluto$reader$blocks$for_block_$_iter__1285(s__1286){
return (new cljs.core.LazySeq(null,((function (vec__1282,k,v,for_values,map__1280,map__1280__$1,wrapper_component,prev_env,bindings){
return (function (){
var s__1286__$1 = s__1286;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__1286__$1);
if(temp__5457__auto__){
var s__1286__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__1286__$2)){
var c__4432__auto__ = cljs.core.chunk_first(s__1286__$2);
var size__4433__auto__ = cljs.core.count(c__4432__auto__);
var b__1288 = cljs.core.chunk_buffer(size__4433__auto__);
if((function (){var i__1287 = (0);
while(true){
if((i__1287 < size__4433__auto__)){
var val = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4432__auto__,i__1287);
cljs.core.chunk_append(b__1288,pluto.reader.blocks.let_block(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$prev_DASH_env,prev_env,cljs.core.cst$kw$bindings,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,val], null)], null),children));

var G__1289 = (i__1287 + (1));
i__1287 = G__1289;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__1288),pluto$reader$blocks$for_block_$_iter__1285(cljs.core.chunk_rest(s__1286__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__1288),null);
}
} else {
var val = cljs.core.first(s__1286__$2);
return cljs.core.cons(pluto.reader.blocks.let_block(new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$prev_DASH_env,prev_env,cljs.core.cst$kw$bindings,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,val], null)], null),children),pluto$reader$blocks$for_block_$_iter__1285(cljs.core.rest(s__1286__$2)));
}
} else {
return null;
}
...
});})(vec__1282,k,v,for_values,map__1280,map__1280__$1,wrapper_component,prev_env,bindings))
,null,null));
});})(vec__1282,k,v,for_values,map__1280,map__1280__$1,wrapper_component,prev_env,bindings))
;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (accum,p__1290){
var vec__1291 = p__1290;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1291,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1291,(1),null);
if(cljs.core.vector_QMARK_(v)){
var map__1294 = (function (){var G__1295 = ctx;
var G__1296 = ext;
var G__1297 = cljs.core.cst$kw$query;
var G__1298 = v;
return (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(G__1295,G__1296,G__1297,G__1298) : pluto.reader.types.resolve.call(null,G__1295,G__1296,G__1297,G__1298));
})();
...
return pluto.reader.errors.error.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pluto$reader$errors_SLASH_invalid_DASH_bindings,p1__1301_SHARP_);
});})(binding_pairs))
,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (binding_pairs){
return (function (p1__1300_SHARP_){
return cljs.core.not(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(pluto.reader.blocks.valid_bindings_QMARK_,p1__1300_SHARP_));
});})(binding_pairs))
...
pluto.reader.blocks.parse.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$let,(function (ctx,ext,p__1302){
var vec__1303 = p__1302;
var seq__1304 = cljs.core.seq(vec__1303);
var first__1305 = cljs.core.first(seq__1304);
var seq__1304__$1 = cljs.core.next(seq__1304);
var _ = first__1305;
var first__1305__$1 = cljs.core.first(seq__1304__$1);
var seq__1304__$2 = cljs.core.next(seq__1304__$1);
var bindings = first__1305__$1;
var body = seq__1304__$2;
...
var map__1306 = pluto.reader.blocks.resolve_and_validate_queries(ctx,ext,bindings);
var map__1306__$1 = (((((!((map__1306 == null))))?(((((map__1306.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1306.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1306):map__1306);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1306__$1,cljs.core.cst$kw$errors);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1306__$1,cljs.core.cst$kw$data);
if(cljs.core.truth_(cljs.core.not_empty(errors))){
...
pluto.reader.blocks.parse.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$for,(function (ctx,ext,p__1308){
var vec__1309 = p__1308;
var seq__1310 = cljs.core.seq(vec__1309);
var first__1311 = cljs.core.first(seq__1310);
var seq__1310__$1 = cljs.core.next(seq__1310);
var _ = first__1311;
var first__1311__$1 = cljs.core.first(seq__1310__$1);
var seq__1310__$2 = cljs.core.next(seq__1310__$1);
var binding = first__1311__$1;
var body = seq__1310__$2;
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body))){
...
if(((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2((2),cljs.core.count(binding))) || (cljs.core.not((function (){var G__1315 = cljs.core.first(binding);
var fexpr__1314 = cljs.core.some_fn.cljs$core$IFn$_invoke$arity$2(cljs.core.symbol_QMARK_,cljs.core.map_QMARK_);
return (fexpr__1314.cljs$core$IFn$_invoke$arity$1 ? fexpr__1314.cljs$core$IFn$_invoke$arity$1(G__1315) : fexpr__1314.call(null,G__1315));
})())))){
...
var map__1316 = pluto.reader.blocks.resolve_and_validate_queries(ctx,ext,binding);
...
var result = map__1316__$1;
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1316__$1,cljs.core.cst$kw$errors);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1316__$1,cljs.core.cst$kw$data);
var errors__$1 = (function (){var G__1318 = errors;
if((wrapper_component == null)){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(G__1318,errors,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([pluto.reader.errors.error.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pluto$reader$errors_SLASH_unknown_DASH_component,cljs.core.cst$sym$wrapper_DASH_component)], 0));
} else {
return G__1318;
}
})();
...
pluto.reader.blocks.parse.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$when,(function (_,___$1,p__1322){
...
pluto.reader.blocks.parse.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$sym$if,(function (_,___$1,p__1335){
var vec__1336 = p__1335;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1336,(0),null);
