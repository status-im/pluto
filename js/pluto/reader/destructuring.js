...
pluto.reader.destructuring.indexed_bindings = (function pluto$reader$destructuring$indexed_bindings(bindings){
...
return pluto.reader.errors.merge_results.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m,(function (){var G__7203 = value;
var G__7204 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(s,idx);
...
return pluto.reader.errors.merge_results.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m,(function (){var G__7205 = value;
var G__7206 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(s,idx);
return (pluto.reader.destructuring.destructure_seq.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.destructuring.destructure_seq.cljs$core$IFn$_invoke$arity$2(G__7205,G__7206) : pluto.reader.destructuring.destructure_seq.call(null,G__7205,G__7206));
})()], 0));
} else {
return null;
}
...
if(((!(cljs.core.sequential_QMARK_(bindings))) || (!(cljs.core.every_QMARK_(pluto.reader.destructuring.valid_bindings_form_QMARK_,bindings))) || ((pluto.reader.destructuring.seq_bindings_size(bindings) > cljs.core.count(s))))){
...
return cljs.core.reduce_kv((function (p1__7207_SHARP_,p2__7208_SHARP_,p3__7209_SHARP_){
return pluto.reader.destructuring.merge_seq_bindings(bindings,s,p1__7207_SHARP_,p2__7208_SHARP_,p3__7209_SHARP_);
}),cljs.core.PersistentArrayMap.EMPTY,pluto.reader.destructuring.indexed_bindings(bindings));

}
});
pluto.reader.destructuring.merge_assoc_bindings = (function pluto$reader$destructuring$merge_assoc_bindings(s,m,k,v){
if(cljs.core.vector_QMARK_(v)){
return cljs.core.assoc_in(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$data,k], null),(function (){var or__3949__auto__ = (function (){var fexpr__7211 = cljs.core.first(v);
return (fexpr__7211.cljs$core$IFn$_invoke$arity$1 ? fexpr__7211.cljs$core$IFn$_invoke$arity$1(s) : fexpr__7211.call(null,s));
})();
...
return pluto.reader.errors.merge_results.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m,(function (){var G__7212 = k;
var G__7213 = (v.cljs$core$IFn$_invoke$arity$1 ? v.cljs$core$IFn$_invoke$arity$1(s) : v.call(null,s));
return (pluto.reader.destructuring.destructure_assoc.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.destructuring.destructure_assoc.cljs$core$IFn$_invoke$arity$2(G__7212,G__7213) : pluto.reader.destructuring.destructure_assoc.call(null,G__7212,G__7213));
})()], 0));
} else {
...
if(((!(cljs.core.map_QMARK_(bindings))) || (!(cljs.core.every_QMARK_(pluto.reader.destructuring.valid_bindings_form_QMARK_,cljs.core.keys(bindings)))))){
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$errors,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.reader.errors.error.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pluto$reader$errors_SLASH_invalid_DASH_destructuring_DASH_format,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$type,cljs.core.cst$kw$assoc,cljs.core.cst$kw$data,bindings], null))], null)], null);
} else {
return cljs.core.reduce_kv((function (p1__7214_SHARP_,p2__7215_SHARP_,p3__7216_SHARP_){
return pluto.reader.destructuring.merge_assoc_bindings(s,p1__7214_SHARP_,p2__7215_SHARP_,p3__7216_SHARP_);
