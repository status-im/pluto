...
return pluto.reader.errors.merge_results.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m,(function (){var G__2010 = value;
var G__2011 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(s,idx);
return (pluto.reader.destructuring.destructure_assoc.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.destructuring.destructure_assoc.cljs$core$IFn$_invoke$arity$2(G__2010,G__2011) : pluto.reader.destructuring.destructure_assoc.call(null,G__2010,G__2011));
})()], 0));
} else {
if(cljs.core.sequential_QMARK_(value)){
return pluto.reader.errors.merge_results.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m,(function (){var G__2012 = value;
var G__2013 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(s,idx);
return (pluto.reader.destructuring.destructure_seq.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.destructuring.destructure_seq.cljs$core$IFn$_invoke$arity$2(G__2012,G__2013) : pluto.reader.destructuring.destructure_seq.call(null,G__2012,G__2013));
})()], 0));
} else {
return null;
}
...
return pluto.reader.destructuring.merge_seq_bindings(bindings,s,p1__2014_SHARP_,p2__2015_SHARP_,p3__2016_SHARP_);
...
return cljs.core.assoc_in(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$data,k], null),(function (){var or__3949__auto__ = (function (){var fexpr__2018 = cljs.core.first(v);
return (fexpr__2018.cljs$core$IFn$_invoke$arity$1 ? fexpr__2018.cljs$core$IFn$_invoke$arity$1(s) : fexpr__2018.call(null,s));
})();
...
return pluto.reader.errors.merge_results.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([m,(function (){var G__2019 = k;
var G__2020 = (v.cljs$core$IFn$_invoke$arity$1 ? v.cljs$core$IFn$_invoke$arity$1(s) : v.call(null,s));
return (pluto.reader.destructuring.destructure_assoc.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.destructuring.destructure_assoc.cljs$core$IFn$_invoke$arity$2(G__2019,G__2020) : pluto.reader.destructuring.destructure_assoc.call(null,G__2019,G__2020));
})()], 0));
} else {
...
return cljs.core.reduce_kv((function (p1__2021_SHARP_,p2__2022_SHARP_,p3__2023_SHARP_){
return pluto.reader.destructuring.merge_assoc_bindings(s,p1__2021_SHARP_,p2__2022_SHARP_,p3__2023_SHARP_);
