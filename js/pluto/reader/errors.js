...
return pluto.reader.errors.accumulate_errors(G__944,errors);
} else {
return G__944;
}
});
...
pluto.reader.errors.merge_result.cljs$core$IFn$_invoke$arity$3 = (function (f,m,p__947){
var map__948 = p__947;
var map__948__$1 = (((((!((map__948 == null))))?(((((map__948.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__948.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__948):map__948);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__948__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__948__$1,cljs.core.cst$kw$errors);
...
/** @this {Function} */
pluto.reader.errors.merge_results.cljs$lang$applyTo = (function (seq951){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq951));
});

pluto.reader.errors.merge_results_with = (function pluto$reader$errors$merge_results_with(var_args){
var args__4736__auto__ = [];
var len__4730__auto___959 = arguments.length;
var i__4731__auto___960 = (0);
while(true){
if((i__4731__auto___960 < len__4730__auto___959)){
args__4736__auto__.push((arguments[i__4731__auto___960]));

var G__961 = (i__4731__auto___960 + (1));
i__4731__auto___960 = G__961;
continue;
} else {
}
break;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__955_SHARP_,p2__956_SHARP_){
return pluto.reader.errors.merge_result.cljs$core$IFn$_invoke$arity$3(f,p1__955_SHARP_,p2__956_SHARP_);
...
/** @this {Function} */
pluto.reader.errors.merge_results_with.cljs$lang$applyTo = (function (seq957){
var G__958 = cljs.core.first(seq957);
var seq957__$1 = cljs.core.next(seq957);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__958,seq957__$1);
});
