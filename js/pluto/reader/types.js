...
var hierarchy__4617__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$hierarchy,(function (){var fexpr__999 = cljs.core.get_global_hierarchy;
return (fexpr__999.cljs$core$IFn$_invoke$arity$0 ? fexpr__999.cljs$core$IFn$_invoke$arity$0() : fexpr__999.call(null));
})());
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(pluto.reader.errors.merge_results_with,(function (p1__1000_SHARP_,p2__1001_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(p1__1000_SHARP_),p2__1001_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__1002_SHARP_){
var G__1003 = ctx;
var G__1004 = ext;
var G__1005 = cljs.core.first(type);
var G__1006 = p1__1002_SHARP_;
return (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(G__1003,G__1004,G__1005,G__1006) : pluto.reader.types.resolve.call(null,G__1003,G__1004,G__1005,G__1006));
}),value));
} else {
...
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$one_DASH_of,(function (_,___$1,p__1007,value){
var map__1008 = p__1007;
var map__1008__$1 = (((((!((map__1008 == null))))?(((((map__1008.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1008.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1008):map__1008);
var one_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1008__$1,cljs.core.cst$kw$one_DASH_of);
...
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$or,(function (ctx,ext,p__1011,value){
var map__1012 = p__1011;
var map__1012__$1 = (((((!((map__1012 == null))))?(((((map__1012.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1012.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1012):map__1012);
var or = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1012__$1,cljs.core.cst$kw$or);
if(cljs.core.coll_QMARK_(or)){
var temp__5718__auto__ = cljs.core.some(((function (map__1012,map__1012__$1,or){
return (function (p1__1010_SHARP_){
var temp__5720__auto__ = (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(ctx,ext,p1__1010_SHARP_,value) : pluto.reader.types.resolve.call(null,ctx,ext,p1__1010_SHARP_,value));
if(cljs.core.truth_(temp__5720__auto__)){
var map__1014 = temp__5720__auto__;
var map__1014__$1 = (((((!((map__1014 == null))))?(((((map__1014.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1014.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1014):map__1014);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1014__$1,cljs.core.cst$kw$data);
return data;
} else {
return null;
}
});})(map__1012,map__1012__$1,or))
,or);
if(cljs.core.truth_(temp__5718__auto__)){
var o = temp__5718__auto__;
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,o], null);
...
pluto.reader.types.resolve_property = (function pluto$reader$types$resolve_property(ctx,ext,m,p__1017,type){
var map__1018 = p__1017;
var map__1018__$1 = (((((!((map__1018 == null))))?(((((map__1018.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1018.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1018):map__1018);
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1018__$1,cljs.core.cst$kw$name);
var optional_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1018__$1,cljs.core.cst$kw$optional_QMARK_);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1018__$1,cljs.core.cst$kw$value);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(pluto.reader.types.sentinel,value)){
var map__1020 = (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(ctx,ext,type,value) : pluto.reader.types.resolve.call(null,ctx,ext,type,value));
var map__1020__$1 = (((((!((map__1020 == null))))?(((((map__1020.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1020.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1020):map__1020);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1020__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1020__$1,cljs.core.cst$kw$errors);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(m,cljs.core.cst$kw$data,((function (map__1018,map__1018__$1,name,optional_QMARK_,value){
return (function (p1__1016_SHARP_){
if(cljs.core.empty_QMARK_(p1__1016_SHARP_)){
return cljs.core.PersistentArrayMap.EMPTY;
} else {
return p1__1016_SHARP_;
}
});})(map__1018,map__1018__$1,name,optional_QMARK_,value))
);
} else {
...
if(cljs.core.map_QMARK_(type)){
return cljs.core.reduce_kv((function (p1__1022_SHARP_,p2__1023_SHARP_,p3__1024_SHARP_){
return pluto.reader.types.resolve_property(ctx,ext,p1__1022_SHARP_,pluto.reader.types.property(p2__1023_SHARP_,value),p3__1024_SHARP_);
...
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$query,(function (p__1025,ext,type,p__1026){
var map__1027 = p__1025;
var map__1027__$1 = (((((!((map__1027 == null))))?(((((map__1027.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1027.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1027):map__1027);
var ctx = map__1027__$1;
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1027__$1,cljs.core.cst$kw$env);
var vec__1028 = p__1026;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1028,(0),null);
var arguments$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1028,(1),null);
var value = vec__1028;
var map__1032 = pluto.reader.reference.resolve(ctx,ext,type,value);
var map__1032__$1 = (((((!((map__1032 == null))))?(((((map__1032.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1032.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__1032):map__1032);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1032__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1032__$1,cljs.core.cst$kw$errors);
