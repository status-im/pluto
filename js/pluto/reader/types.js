...
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$one_DASH_of,(function (_,___$1,p__2016,value){
...
var one_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2017__$1,cljs.core.cst$kw$one_DASH_of);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(pluto.reader.errors.merge_results_with,(function (p1__2019_SHARP_,p2__2020_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(p1__2019_SHARP_),p2__2020_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__2021_SHARP_){
var G__2022 = ctx;
var G__2023 = ext;
var G__2024 = cljs.core.first(type);
var G__2025 = p1__2021_SHARP_;
return (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(G__2022,G__2023,G__2024,G__2025) : pluto.reader.types.resolve.call(null,G__2022,G__2023,G__2024,G__2025));
}),value));
} else {
...
pluto.reader.types.resolve_property = (function pluto$reader$types$resolve_property(ctx,ext,m,p__2027,type){
var map__2028 = p__2027;
...
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2028__$1,cljs.core.cst$kw$name);
var optional_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2028__$1,cljs.core.cst$kw$optional_QMARK_);
...
var map__2030 = (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(ctx,ext,type,value) : pluto.reader.types.resolve.call(null,ctx,ext,type,value));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(m,cljs.core.cst$kw$data,((function (map__2028,map__2028__$1,name,optional_QMARK_,value){
return (function (p1__2026_SHARP_){
if(cljs.core.empty_QMARK_(p1__2026_SHARP_)){
return cljs.core.PersistentArrayMap.EMPTY;
} else {
return p1__2026_SHARP_;
}
});})(map__2028,map__2028__$1,name,optional_QMARK_,value))
);
} else {
...
return pluto.reader.types.resolve_property(ctx,ext,p1__2032_SHARP_,pluto.reader.types.property(p2__2033_SHARP_,value),p3__2034_SHARP_);
...
var env__$1 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([env,cljs.core.reduce_kv((function (p1__2035_SHARP_,p2__2036_SHARP_,p3__2037_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__2035_SHARP_,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(cljs.core.name(p2__2036_SHARP_)),p3__2037_SHARP_);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__2038_SHARP_,p2__2039_SHARP_,((cljs.core.contains_QMARK_(env__$1,p3__2040_SHARP_))?cljs.core.get.cljs$core$IFn$_invoke$arity$2(env__$1,p3__2040_SHARP_):p3__2040_SHARP_));
});})(env__$1))
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__2041_SHARP_,p2__2042_SHARP_,pluto.reader.types.replace_atom(dic,p3__2043_SHARP_));
});})(env__$1,dic))
...
var map__2044 = pluto.reader.types.resolve_arguments(ctx,ext,event,arguments$);
...
var vec__2046 = data;
var form = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2046,(0),null);
var bindings = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2046,(1),null);
 ...
 */
pluto.reader.types.resolve_local_reference = (function pluto$reader$types$resolve_local_reference(ctx,ext,type,p__2049){
var vec__2050 = p__2049;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2050,(0),null);
var value = vec__2050;
var map__2053 = pluto.reader.reference.resolve(ctx,ext,type,value);
...
var m = map__2053__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2053__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2053__$1,cljs.core.cst$kw$errors);
if(cljs.core.truth_(data)){
if(cljs.core.truth_(pluto.reader.types.local_event_QMARK_(data))){
var vec__2055 = pluto.reader.types.reference_symbol(data);
var event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2055,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2055,(1),null);
var reference = vec__2055;
var bindings = cljs.core.first(cljs.core.second(data));
var map__2058 = pluto.reader.reference.resolve(ctx,ext,type,reference);
...
var data__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2058__$1,cljs.core.cst$kw$data);
var errors__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2058__$1,cljs.core.cst$kw$errors);
...
pluto.reader.types.resolve_event = (function pluto$reader$types$resolve_event(ctx,ext,type,p__2060){
var vec__2061 = p__2060;
var symbol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2061,(0),null);
var arguments$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2061,(1),null);
var value = vec__2061;
var map__2064 = pluto.reader.types.resolve_local_reference(ctx,ext,type,value);
...
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2064__$1,cljs.core.cst$kw$errors);
var map__2065 = data;
...
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2065__$1,cljs.core.cst$kw$event);
var ref = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2065__$1,cljs.core.cst$kw$ref);
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2065__$1,cljs.core.cst$kw$args);
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2065__$1,cljs.core.cst$kw$bindings);
...
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$event,(function (ctx,ext,type,p__2068){
var vec__2069 = p__2068;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2069,(0),null);
var arguments$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2069,(1),null);
var value = vec__2069;
return pluto.reader.types.resolve_event(ctx,ext,type,value);
}));
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$query,(function (ctx,ext,type,p__2072){
var vec__2073 = p__2072;
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2073,(0),null);
var arguments$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2073,(1),null);
var value = vec__2073;
var map__2076 = pluto.reader.reference.resolve(ctx,ext,type,value);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2076__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2076__$1,cljs.core.cst$kw$errors);
