...
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$one_DASH_of,(function (_,___$1,p__2050,value){
var map__2051 = p__2050;
...
var one_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2051__$1,cljs.core.cst$kw$one_DASH_of);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(pluto.reader.errors.merge_results_with,(function (p1__2053_SHARP_,p2__2054_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.vec(p1__2053_SHARP_),p2__2054_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__2055_SHARP_){
var G__2056 = ctx;
var G__2057 = ext;
var G__2058 = cljs.core.first(type);
var G__2059 = p1__2055_SHARP_;
return (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(G__2056,G__2057,G__2058,G__2059) : pluto.reader.types.resolve.call(null,G__2056,G__2057,G__2058,G__2059));
}),value));
} else {
...
pluto.reader.types.resolve_property = (function pluto$reader$types$resolve_property(ctx,ext,m,p__2061,type){
...
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2062__$1,cljs.core.cst$kw$name);
var optional_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2062__$1,cljs.core.cst$kw$optional_QMARK_);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2062__$1,cljs.core.cst$kw$value);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(pluto.reader.types.sentinel,value)){
var map__2064 = (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(ctx,ext,type,value) : pluto.reader.types.resolve.call(null,ctx,ext,type,value));
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(m,cljs.core.cst$kw$data,((function (map__2062,map__2062__$1,name,optional_QMARK_,value){
return (function (p1__2060_SHARP_){
if(cljs.core.empty_QMARK_(p1__2060_SHARP_)){
return cljs.core.PersistentArrayMap.EMPTY;
} else {
return p1__2060_SHARP_;
}
});})(map__2062,map__2062__$1,name,optional_QMARK_,value))
);
} else {
...
if(cljs.core.map_QMARK_(type)){
return cljs.core.reduce_kv((function (p1__2066_SHARP_,p2__2067_SHARP_,p3__2068_SHARP_){
return pluto.reader.types.resolve_property(ctx,ext,p1__2066_SHARP_,pluto.reader.types.property(p2__2067_SHARP_,value),p3__2068_SHARP_);
...
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$event,(function (_,___$1,___$2,value){
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,(function (){
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(value) : re_frame.core.dispatch.call(null,value));
})], null);
}));
pluto.reader.types.resolve.cljs$core$IMultiFn$_add_method$arity$3(null,cljs.core.cst$kw$query,(function (ctx,_,___$1,value){
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,(function (){
var temp__5457__auto__ = (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(value) : re_frame.core.subscribe.call(null,value));
