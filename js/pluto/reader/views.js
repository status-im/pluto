...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__1418_SHARP_,p2__1417_SHARP_){
var map__1419 = (pluto.reader.views.parse.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.views.parse.cljs$core$IFn$_invoke$arity$4(ctx,ext,parent,p2__1417_SHARP_) : pluto.reader.views.parse.call(null,ctx,ext,parent,p2__1417_SHARP_));
...
return pluto.reader.errors.merge_errors(cljs.core.update.cljs$core$IFn$_invoke$arity$4(p1__1418_SHARP_,cljs.core.cst$kw$data,cljs.core.conj,data),errors);
...
pluto.reader.views.resolve_component = (function pluto$reader$views$resolve_component(ctx,ext,p__1421){
var vec__1422 = p__1421;
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1422,(0),null);
var o = vec__1422;
if(pluto.reader.views.block_QMARK_(element)){
return element;
} else {
if((element instanceof cljs.core.Symbol)){
var or__4047__auto__ = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ctx,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$capacities,cljs.core.cst$kw$components,element,cljs.core.cst$kw$data], null));
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
return cljs.core.cst$kw$data.cljs$core$IFn$_invoke$arity$1((function (){var G__1425 = ctx;
var G__1426 = ext;
var G__1427 = cljs.core.cst$kw$view;
var G__1428 = o;
return (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(G__1425,G__1426,G__1427,G__1428) : pluto.reader.types.resolve.call(null,G__1425,G__1426,G__1427,G__1428));
})());
}
} else {
return null;
...
var hierarchy__4528__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$hierarchy,(function (){var fexpr__1429 = cljs.core.get_global_hierarchy;
return (fexpr__1429.cljs$core$IFn$_invoke$arity$0 ? fexpr__1429.cljs$core$IFn$_invoke$arity$0() : fexpr__1429.call(null));
})());
...
return cljs.core.not((function (){var fexpr__1430 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$event,null,cljs.core.cst$kw$view,null], null), null);
return (fexpr__1430.cljs$core$IFn$_invoke$arity$1 ? fexpr__1430.cljs$core$IFn$_invoke$arity$1(type) : fexpr__1430.call(null,type));
})());
} else {
...
var map__1431 = (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(ctx,ext,type,v) : pluto.reader.types.resolve.call(null,ctx,ext,type,v));
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1431__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1431__$1,cljs.core.cst$kw$errors);
...
if(cljs.core.truth_((function (){var G__1433 = ctx;
var G__1434 = ext;
var G__1435 = cljs.core.cst$kw$view;
var G__1436 = v;
return (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(G__1433,G__1434,G__1435,G__1436) : pluto.reader.types.resolve.call(null,G__1433,G__1434,G__1435,G__1436));
})())){
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,v], null);
} else {
...
var map__1437 = pluto.reader.views.resolve_property(ctx,ext,component,k,v);
...
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1437__$1,cljs.core.cst$kw$errors);
...
pluto.reader.views.resolve_properties_children = (function pluto$reader$views$resolve_properties_children(p__1439){
var vec__1440 = p__1439;
var seq__1441 = cljs.core.seq(vec__1440);
var first__1442 = cljs.core.first(seq__1441);
var seq__1441__$1 = cljs.core.next(seq__1441);
var properties_QMARK_ = first__1442;
var children = seq__1441__$1;
...
var vec__1444 = o;
var seq__1445 = cljs.core.seq(vec__1444);
var first__1446 = cljs.core.first(seq__1445);
var seq__1445__$1 = cljs.core.next(seq__1445);
var element = first__1446;
var properties_children = seq__1445__$1;
var component = pluto.reader.views.resolve_component(ctx,ext,o);
var vec__1447 = pluto.reader.views.resolve_properties_children(properties_children);
var properties = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1447,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1447,(1),null);
var map__1450 = (cljs.core.truth_(properties)?pluto.reader.views.resolve_component_properties(ctx,ext,element,properties):null);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1450__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1450__$1,cljs.core.cst$kw$errors);
var G__1452 = (function (){var m = pluto.reader.views.parse_hiccup_children(ctx,ext,o,children);
if(cljs.core.truth_(component)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(m,cljs.core.cst$kw$data,((function (m,vec__1444,seq__1445,first__1446,seq__1445__$1,element,properties_children,component,vec__1447,properties,children,map__1450,map__1450__$1,data,errors,explain){
return (function (p1__1443_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,(cljs.core.truth_(data)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [component,data], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [component], null)),p1__1443_SHARP_);
});})(m,vec__1444,seq__1445,first__1446,seq__1445__$1,element,properties_children,component,vec__1447,properties,children,map__1450,map__1450__$1,data,errors,explain))
);
} else {
return m;
}
})();
var G__1452__$1 = (((component == null))?pluto.reader.errors.accumulate_errors(G__1452,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.reader.errors.error.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pluto$reader$errors_SLASH_unknown_DASH_component,element)], null)):G__1452);
if(cljs.core.seq(errors)){
return pluto.reader.errors.accumulate_errors(G__1452__$1,errors);
} else {
return G__1452__$1;
}
} else {
...
if(cljs.core.vector_QMARK_(o)){
var vec__1455 = o;
var seq__1456 = cljs.core.seq(vec__1455);
var first__1457 = cljs.core.first(seq__1456);
var seq__1456__$1 = cljs.core.next(seq__1456);
var _ = first__1457;
var first__1457__$1 = cljs.core.first(seq__1456__$1);
var seq__1456__$2 = cljs.core.next(seq__1456__$1);
var ___$1 = first__1457__$1;
var children = seq__1456__$2;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (vec__1455,seq__1456,first__1457,seq__1456__$1,_,first__1457__$1,seq__1456__$2,___$1,children){
return (function (p1__1453_SHARP_,p2__1454_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,p1__1453_SHARP_,(pluto.reader.views.unresolved_properties.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.views.unresolved_properties.cljs$core$IFn$_invoke$arity$2(acc,p2__1454_SHARP_) : pluto.reader.views.unresolved_properties.call(null,acc,p2__1454_SHARP_)));
});})(vec__1455,seq__1456,first__1457,seq__1456__$1,_,first__1457__$1,seq__1456__$2,___$1,children))
,acc,children);
} else {
return acc;
...
var map__1458 = (function (){var G__1459 = ctx;
var G__1460 = ext;
var G__1461 = cljs.core.cst$kw$event;
var G__1462 = event;
return (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(G__1459,G__1460,G__1461,G__1462) : pluto.reader.types.resolve.call(null,G__1459,G__1460,G__1461,G__1462));
})();
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1458__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1458__$1,cljs.core.cst$kw$errors);
if(cljs.core.truth_(data)){
var G__1464 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$a,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(o) : f.call(null,o))], null);
return (data.cljs$core$IFn$_invoke$arity$1 ? data.cljs$core$IFn$_invoke$arity$1(G__1464) : data.call(null,G__1464));
} else {
return null;
}
} else {
...
var vec__1466 = h;
var seq__1467 = cljs.core.seq(vec__1466);
var first__1468 = cljs.core.first(seq__1467);
var seq__1467__$1 = cljs.core.next(seq__1467);
var tag = first__1468;
var properties_children = seq__1467__$1;
var vec__1469 = pluto.reader.views.resolve_properties_children(properties_children);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1469,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1469,(1),null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,(cljs.core.truth_(props__$1)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,props__$1], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag], null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (vec__1466,seq__1467,first__1468,seq__1467__$1,tag,properties_children,vec__1469,props,children,props__$1){
return (function (p1__1465_SHARP_){
return (pluto.reader.views.inject_properties.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.views.inject_properties.cljs$core$IFn$_invoke$arity$2(p1__1465_SHARP_,properties) : pluto.reader.views.inject_properties.call(null,p1__1465_SHARP_,properties));
});})(vec__1466,seq__1467,first__1468,seq__1467__$1,tag,properties_children,vec__1469,props,children,props__$1))
,children));
} else {
return h;
}
});
pluto.reader.views.create_reagent_spec = (function pluto$reader$views$create_reagent_spec(ctx,ext,p__1485,data){
...
var get_initial_state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1486__$1,cljs.core.cst$kw$get_DASH_initial_DASH_state);
var component_will_receive_props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1486__$1,cljs.core.cst$kw$component_DASH_will_DASH_receive_DASH_props);
var should_component_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1486__$1,cljs.core.cst$kw$should_DASH_component_DASH_update);
var component_will_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1486__$1,cljs.core.cst$kw$component_DASH_will_DASH_mount);
var component_did_mount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1486__$1,cljs.core.cst$kw$component_DASH_did_DASH_mount);
var component_will_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1486__$1,cljs.core.cst$kw$component_DASH_will_DASH_update);
var component_did_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1486__$1,cljs.core.cst$kw$component_DASH_did_DASH_update);
var component_will_unmount = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1486__$1,cljs.core.cst$kw$component_DASH_will_DASH_unmount);
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$display_DASH_name,cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(data)),cljs.core.cst$kw$reagent_DASH_render,((function (map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount){
return (function (o){
...
});})(map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount))
], null),(cljs.core.truth_(get_initial_state)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$get_DASH_initial_DASH_state_DASH_mount,pluto.reader.views.event__GT_fn(ctx,ext,get_initial_state,((function (map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount){
return (function (p1__1472_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(p1__1472_SHARP_);
});})(map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount))
)], null):null),(cljs.core.truth_(component_will_receive_props)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$component_DASH_will_DASH_receive_DASH_props,pluto.reader.views.event__GT_fn(ctx,ext,component_will_receive_props,((function (map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount){
return (function (p1__1473_SHARP_,p2__1474_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(p1__1473_SHARP_),cljs.core.cst$kw$new,p2__1474_SHARP_);
});})(map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount))
)], null):null),(cljs.core.truth_(should_component_update)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$should_DASH_component_DASH_update,pluto.reader.views.event__GT_fn(ctx,ext,should_component_update,((function (map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount){
return (function (p1__1475_SHARP_,p2__1476_SHARP_,p3__1477_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(p1__1475_SHARP_),cljs.core.cst$kw$old,p2__1476_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.cst$kw$new,p3__1477_SHARP_], 0));
});})(map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount))
)], null):null),(cljs.core.truth_(component_will_mount)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$component_DASH_will_DASH_mount,pluto.reader.views.event__GT_fn(ctx,ext,component_will_mount,((function (map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount){
return (function (p1__1478_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(p1__1478_SHARP_);
});})(map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount))
)], null):null),(cljs.core.truth_(component_did_mount)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$component_DASH_did_DASH_mount,pluto.reader.views.event__GT_fn(ctx,ext,component_did_mount,((function (map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount){
return (function (p1__1479_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(p1__1479_SHARP_);
});})(map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount))
)], null):null),(cljs.core.truth_(component_will_update)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$component_DASH_will_DASH_update,pluto.reader.views.event__GT_fn(ctx,ext,component_will_update,((function (map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount){
return (function (p1__1480_SHARP_,p2__1481_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(p1__1480_SHARP_),cljs.core.cst$kw$new,p2__1481_SHARP_);
});})(map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount))
)], null):null),(cljs.core.truth_(component_did_update)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$component_DASH_did_DASH_update,pluto.reader.views.event__GT_fn(ctx,ext,component_did_update,((function (map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount){
return (function (p1__1482_SHARP_,p2__1483_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(p1__1482_SHARP_),cljs.core.cst$kw$old,p2__1483_SHARP_);
});})(map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount))
)], null):null),(cljs.core.truth_(component_will_unmount)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$component_DASH_will_DASH_unmount,pluto.reader.views.event__GT_fn(ctx,ext,component_will_unmount,((function (map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount){
return (function (p1__1484_SHARP_){
return cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(p1__1484_SHARP_);
});})(map__1486,map__1486__$1,get_initial_state,component_will_receive_props,should_component_update,component_will_mount,component_did_mount,component_will_update,component_did_update,component_will_unmount))
)], null):null)], 0));
});
pluto.reader.views.parse = (function pluto$reader$views$parse(var_args){
var G__1489 = arguments.length;
switch (G__1489) {
case 3:
...
var map__1490 = pluto.reader.views.parse.cljs$core$IFn$_invoke$arity$4(ctx,ext,null,((cljs.core.map_QMARK_(o))?cljs.core.cst$kw$view.cljs$core$IFn$_invoke$arity$1(o):o));
...
var m = map__1490__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1490__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1490__$1,cljs.core.cst$kw$errors);
...
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,((function (map__1490,map__1490__$1,m,data,errors){
...
});})(map__1490,map__1490__$1,m,data,errors))
], null);
}
}
});
...
var map__1492 = (pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$4(ctx,ext,parent,o) : pluto.reader.blocks.parse.call(null,ctx,ext,parent,o));
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1492__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1492__$1,cljs.core.cst$kw$errors);
if(cljs.core.truth_(errors)){
...
var map__1495 = pluto.reader.reference.resolve(ctx,ext,type,value);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1495__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1495__$1,cljs.core.cst$kw$errors);
if(cljs.core.truth_(data)){
