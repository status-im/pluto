...
var hierarchy__4528__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$hierarchy,(function (){var fexpr__1347 = cljs.core.get_global_hierarchy;
return (fexpr__1347.cljs$core$IFn$_invoke$arity$0 ? fexpr__1347.cljs$core$IFn$_invoke$arity$0() : fexpr__1347.call(null));
})());
...
return cljs.core.not((function (){var fexpr__1348 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$event,null,cljs.core.cst$kw$view,null], null), null);
return (fexpr__1348.cljs$core$IFn$_invoke$arity$1 ? fexpr__1348.cljs$core$IFn$_invoke$arity$1(type) : fexpr__1348.call(null,type));
})());
} else {
...
var map__1349 = (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(ctx,ext,type,v) : pluto.reader.types.resolve.call(null,ctx,ext,type,v));
...
var map__1351 = pluto.reader.views.resolve_property(ctx,ext,component,k,v);
...
pluto.reader.views.resolve_properties_children = (function pluto$reader$views$resolve_properties_children(p__1353){
var vec__1354 = p__1353;
var seq__1355 = cljs.core.seq(vec__1354);
var first__1356 = cljs.core.first(seq__1355);
var seq__1355__$1 = cljs.core.next(seq__1355);
var properties_QMARK_ = first__1356;
var children = seq__1355__$1;
...
var vec__1358 = o;
var seq__1359 = cljs.core.seq(vec__1358);
var first__1360 = cljs.core.first(seq__1359);
var seq__1359__$1 = cljs.core.next(seq__1359);
var element = first__1360;
var properties_children = seq__1359__$1;
var vec__1361 = pluto.reader.views.resolve_properties_children(properties_children);
var properties = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1361,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1361,(1),null);
var component = pluto.reader.views.resolve_component(ctx,element);
var map__1364 = (cljs.core.truth_(properties)?pluto.reader.views.resolve_component_properties(ctx,ext,element,properties):null);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1364__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1364__$1,cljs.core.cst$kw$errors);
var G__1366 = (function (){var m = pluto.reader.views.parse_hiccup_children(ctx,ext,children);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(m,cljs.core.cst$kw$data,((function (m,vec__1358,seq__1359,first__1360,seq__1359__$1,element,properties_children,vec__1361,properties,children,component,map__1364,map__1364__$1,data,errors,explain){
...
})()], null)),p1__1357_SHARP_);
});})(m,vec__1358,seq__1359,first__1360,seq__1359__$1,element,properties_children,vec__1361,properties,children,component,map__1364,map__1364__$1,data,errors,explain))
);
})();
var G__1366__$1 = (((component == null))?pluto.reader.errors.accumulate_errors(G__1366,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.reader.errors.error.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pluto$reader$errors_SLASH_unknown_DASH_component,element)], null)):G__1366);
if(cljs.core.seq(errors)){
return pluto.reader.errors.accumulate_errors(G__1366__$1,errors);
} else {
return G__1366__$1;
}
} else {
...
var component = first__1371;
var first__1371__$1 = cljs.core.first(seq__1370__$1);
var seq__1370__$2 = cljs.core.next(seq__1370__$1);
var properties = first__1371__$1;
var children = seq__1370__$2;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (vec__1369,seq__1370,first__1371,seq__1370__$1,component,first__1371__$1,seq__1370__$2,properties,children){
return (function (p1__1367_SHARP_,p2__1368_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,p1__1367_SHARP_,(pluto.reader.views.unresolved_properties.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.views.unresolved_properties.cljs$core$IFn$_invoke$arity$2(acc,p2__1368_SHARP_) : pluto.reader.views.unresolved_properties.call(null,acc,p2__1368_SHARP_)));
});})(vec__1369,seq__1370,first__1371,seq__1370__$1,component,first__1371__$1,seq__1370__$2,properties,children))
,acc,children);
} else {
return acc;
...
var map__1372 = (pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3 ? pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3(ctx,ext,o) : pluto.reader.blocks.parse.call(null,ctx,ext,o));
...
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1372__$1,cljs.core.cst$kw$errors);
...
var vec__1375 = h;
var seq__1376 = cljs.core.seq(vec__1375);
var first__1377 = cljs.core.first(seq__1376);
var seq__1376__$1 = cljs.core.next(seq__1376);
var tag = first__1377;
var properties_children = seq__1376__$1;
var vec__1378 = pluto.reader.views.resolve_properties_children(properties_children);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1378,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1378,(1),null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,(cljs.core.truth_(props__$1)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,props__$1], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag], null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (vec__1375,seq__1376,first__1377,seq__1376__$1,tag,properties_children,vec__1378,props,children,props__$1){
return (function (p1__1374_SHARP_){
return (pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2(p1__1374_SHARP_,properties) : pluto.reader.views.hiccup_with_properties.call(null,p1__1374_SHARP_,properties));
});})(vec__1375,seq__1376,first__1377,seq__1376__$1,tag,properties_children,vec__1378,props,children,props__$1))
,children));
} else {
return h;
}
...
var map__1383 = pluto.reader.views.parse(ctx,ext,data);
...
var m = map__1383__$1;
var data__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1383__$1,cljs.core.cst$kw$data);
var errors__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1383__$1,cljs.core.cst$kw$errors);
return pluto.reader.errors.merge_errors((cljs.core.truth_(data__$1)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,((function (map__1383,map__1383__$1,m,data__$1,errors__$1,map__1381,map__1381__$1,data,errors){
return (function (o){
return pluto.reader.views.hiccup_with_properties(data__$1,o);
});})(map__1383,map__1383__$1,m,data__$1,errors__$1,map__1381,map__1381__$1,data,errors))
