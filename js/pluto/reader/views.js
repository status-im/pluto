...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__2097_SHARP_,p2__2096_SHARP_){
var map__2098 = (pluto.reader.views.parse.cljs$core$IFn$_invoke$arity$3 ? pluto.reader.views.parse.cljs$core$IFn$_invoke$arity$3(ctx,ext,p2__2096_SHARP_) : pluto.reader.views.parse.call(null,ctx,ext,p2__2096_SHARP_));
...
return pluto.reader.errors.merge_errors(cljs.core.update.cljs$core$IFn$_invoke$arity$4(p1__2097_SHARP_,cljs.core.cst$kw$data,cljs.core.conj,data),errors);
...
var map__2100 = pluto.reader.views.resolve_property(ctx,ext,component,k,v);
...
pluto.reader.views.resolve_properties_children = (function pluto$reader$views$resolve_properties_children(p__2102){
var vec__2103 = p__2102;
var seq__2104 = cljs.core.seq(vec__2103);
var first__2105 = cljs.core.first(seq__2104);
var seq__2104__$1 = cljs.core.next(seq__2104);
var properties_QMARK_ = first__2105;
var children = seq__2104__$1;
...
var element = first__2109;
var properties_children = seq__2108__$1;
var vec__2110 = pluto.reader.views.resolve_properties_children(properties_children);
var properties = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2110,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2110,(1),null);
var component = pluto.reader.views.resolve_component(ctx,element);
var map__2113 = (cljs.core.truth_(properties)?pluto.reader.views.resolve_component_properties(ctx,ext,element,properties):null);
...
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2113__$1,cljs.core.cst$kw$errors);
var G__2115 = (function (){var m = pluto.reader.views.parse_hiccup_children(ctx,ext,children);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(m,cljs.core.cst$kw$data,((function (m,vec__2107,seq__2108,first__2109,seq__2108__$1,element,properties_children,vec__2110,properties,children,component,map__2113,map__2113__$1,data,errors,explain){
...
})()], null)),p1__2106_SHARP_);
});})(m,vec__2107,seq__2108,first__2109,seq__2108__$1,element,properties_children,vec__2110,properties,children,component,map__2113,map__2113__$1,data,errors,explain))
);
})();
var G__2115__$1 = (((component == null))?pluto.reader.errors.accumulate_errors(G__2115,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.reader.errors.error.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pluto$reader$errors_SLASH_unknown_DASH_component,element)], null)):G__2115);
if(cljs.core.seq(errors)){
return pluto.reader.errors.accumulate_errors(G__2115__$1,errors);
} else {
return G__2115__$1;
}
} else {
...
var map__2116 = (pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3 ? pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3(ctx,ext,o) : pluto.reader.blocks.parse.call(null,ctx,ext,o));
...
var map__2118 = pluto.reader.destructuring.destructure(ps,properties);
...
var tag = first__2123;
var properties_children = seq__2122__$1;
var vec__2124 = pluto.reader.views.resolve_properties_children(properties_children);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2124,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2124,(1),null);
var map__2127 = (cljs.core.truth_(properties)?pluto.reader.views.inject_properties(props,properties):null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,(cljs.core.truth_(data)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,data], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag], null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (vec__2121,seq__2122,first__2123,seq__2122__$1,tag,properties_children,vec__2124,props,children,map__2127,map__2127__$1,data){
return (function (p1__2120_SHARP_){
return (pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2(p1__2120_SHARP_,properties) : pluto.reader.views.hiccup_with_properties.call(null,p1__2120_SHARP_,properties));
});})(vec__2121,seq__2122,first__2123,seq__2122__$1,tag,properties_children,vec__2124,props,children,map__2127,map__2127__$1,data))
,children));
} else {
return h;
}
...
var map__2131 = pluto.reader.views.parse(ctx,ext,data);
...
var m = map__2131__$1;
var data__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2131__$1,cljs.core.cst$kw$data);
var errors__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2131__$1,cljs.core.cst$kw$errors);
return pluto.reader.errors.merge_errors((cljs.core.truth_(data__$1)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,((function (map__2131,map__2131__$1,m,data__$1,errors__$1,map__2129,map__2129__$1,data,errors){
return (function (o){
return pluto.reader.views.hiccup_with_properties(data__$1,o);
});})(map__2131,map__2131__$1,m,data__$1,errors__$1,map__2129,map__2129__$1,data,errors))
