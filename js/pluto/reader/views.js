...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__2066_SHARP_,p2__2065_SHARP_){
var map__2067 = (pluto.reader.views.parse.cljs$core$IFn$_invoke$arity$3 ? pluto.reader.views.parse.cljs$core$IFn$_invoke$arity$3(ctx,ext,p2__2065_SHARP_) : pluto.reader.views.parse.call(null,ctx,ext,p2__2065_SHARP_));
var map__2067__$1 = ((((!((map__2067 == null)))?(((((map__2067.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2067.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__2067):map__2067);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2067__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2067__$1,cljs.core.cst$kw$errors);
return pluto.reader.errors.merge_errors(cljs.core.update.cljs$core$IFn$_invoke$arity$4(p1__2066_SHARP_,cljs.core.cst$kw$data,cljs.core.conj,data),errors);
...
var map__2069 = pluto.reader.views.resolve_property(ctx,ext,component,k,v);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2069__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2069__$1,cljs.core.cst$kw$errors);
...
pluto.reader.views.resolve_properties_children = (function pluto$reader$views$resolve_properties_children(p__2071){
var vec__2072 = p__2071;
var seq__2073 = cljs.core.seq(vec__2072);
var first__2074 = cljs.core.first(seq__2073);
var seq__2073__$1 = cljs.core.next(seq__2073);
var properties_QMARK_ = first__2074;
var children = seq__2073__$1;
...
var element = first__2078;
var properties_children = seq__2077__$1;
var vec__2079 = pluto.reader.views.resolve_properties_children(properties_children);
var properties = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2079,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2079,(1),null);
var component = pluto.reader.views.resolve_component(ctx,element);
var map__2082 = (cljs.core.truth_(properties)?pluto.reader.views.resolve_component_properties(ctx,ext,element,properties):null);
...
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2082__$1,cljs.core.cst$kw$errors);
var G__2084 = (function (){var m = pluto.reader.views.parse_hiccup_children(ctx,ext,children);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(m,cljs.core.cst$kw$data,((function (m,vec__2076,seq__2077,first__2078,seq__2077__$1,element,properties_children,vec__2079,properties,children,component,map__2082,map__2082__$1,data,errors,explain){
...
})()], null)),p1__2075_SHARP_);
});})(m,vec__2076,seq__2077,first__2078,seq__2077__$1,element,properties_children,vec__2079,properties,children,component,map__2082,map__2082__$1,data,errors,explain))
);
})();
var G__2084__$1 = (((component == null))?pluto.reader.errors.accumulate_errors(G__2084,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.reader.errors.error.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pluto$reader$errors_SLASH_unknown_DASH_component,element)], null)):G__2084);
if(cljs.core.seq(errors)){
return pluto.reader.errors.accumulate_errors(G__2084__$1,errors);
} else {
return G__2084__$1;
}
} else {
...
var map__2085 = (pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3 ? pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3(ctx,ext,o) : pluto.reader.blocks.parse.call(null,ctx,ext,o));
...
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2085__$1,cljs.core.cst$kw$errors);
...
var map__2087 = pluto.reader.destructuring.destructure(ps,properties);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2087__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2087__$1,cljs.core.cst$kw$errors);
...
var tag = first__2092;
var properties_children = seq__2091__$1;
var vec__2093 = pluto.reader.views.resolve_properties_children(properties_children);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2093,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2093,(1),null);
var map__2096 = (cljs.core.truth_(properties)?pluto.reader.views.inject_properties(props,properties):null);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2096__$1,cljs.core.cst$kw$data);
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,(cljs.core.truth_(data)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,data], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag], null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (vec__2090,seq__2091,first__2092,seq__2091__$1,tag,properties_children,vec__2093,props,children,map__2096,map__2096__$1,data){
return (function (p1__2089_SHARP_){
return (pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2(p1__2089_SHARP_,properties) : pluto.reader.views.hiccup_with_properties.call(null,p1__2089_SHARP_,properties));
});})(vec__2090,seq__2091,first__2092,seq__2091__$1,tag,properties_children,vec__2093,props,children,map__2096,map__2096__$1,data))
,children));
} else {
return h;
}
...
var map__2098 = pluto.reader.reference.resolve(ctx,ext,type,value);
...
var map__2100 = pluto.reader.views.parse(ctx,ext,data);
...
var m = map__2100__$1;
var data__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2100__$1,cljs.core.cst$kw$data);
var errors__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2100__$1,cljs.core.cst$kw$errors);
return pluto.reader.errors.merge_errors((cljs.core.truth_(data__$1)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,((function (map__2100,map__2100__$1,m,data__$1,errors__$1,map__2098,map__2098__$1,data,errors){
return (function (o){
return pluto.reader.views.hiccup_with_properties(data__$1,o);
});})(map__2100,map__2100__$1,m,data__$1,errors__$1,map__2098,map__2098__$1,data,errors))
