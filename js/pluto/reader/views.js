...
return cljs.core.not((function (){var fexpr__2015 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$event,null,cljs.core.cst$kw$view,null], null), null);
return (fexpr__2015.cljs$core$IFn$_invoke$arity$1 ? fexpr__2015.cljs$core$IFn$_invoke$arity$1(type) : fexpr__2015.call(null,type));
})());
} else {
...
var map__2016 = (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(ctx,ext,type,v) : pluto.reader.types.resolve.call(null,ctx,ext,type,v));
var map__2016__$1 = ((((!((map__2016 == null)))?(((((map__2016.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2016.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__2016):map__2016);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2016__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2016__$1,cljs.core.cst$kw$errors);
return pluto.reader.errors.merge_errors((cljs.core.truth_(data)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,cljs.core.with_meta(((function (map__2016,map__2016__$1,data,errors,type,temp__5455__auto__){
return (function (env,o){
return (data.cljs$core$IFn$_invoke$arity$2 ? data.cljs$core$IFn$_invoke$arity$2(env,o) : data.call(null,env,o));
});})(map__2016,map__2016__$1,data,errors,type,temp__5455__auto__))
,cljs.core.cst$kw$event)], null):null),errors);
} else {
return v;
}
} else {
...
var map__2018 = pluto.reader.views.resolve_property(ctx,ext,component,k,v);
var map__2018__$1 = ((((!((map__2018 == null)))?(((((map__2018.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2018.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__2018):map__2018);
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2018__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2018__$1,cljs.core.cst$kw$errors);
...
pluto.reader.views.resolve_properties_children = (function pluto$reader$views$resolve_properties_children(p__2020){
var vec__2021 = p__2020;
var seq__2022 = cljs.core.seq(vec__2021);
var first__2023 = cljs.core.first(seq__2022);
var seq__2022__$1 = cljs.core.next(seq__2022);
var properties_QMARK_ = first__2023;
var children = seq__2022__$1;
...
var vec__2025 = o;
var seq__2026 = cljs.core.seq(vec__2025);
var first__2027 = cljs.core.first(seq__2026);
var seq__2026__$1 = cljs.core.next(seq__2026);
var element = first__2027;
var properties_children = seq__2026__$1;
var vec__2028 = pluto.reader.views.resolve_properties_children(properties_children);
var properties = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2028,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2028,(1),null);
var component = pluto.reader.views.resolve_component(ctx,element);
var map__2031 = (cljs.core.truth_(properties)?pluto.reader.views.resolve_component_properties(ctx,ext,element,properties):null);
...
var G__2033 = (function (){var m = pluto.reader.views.parse_hiccup_children(ctx,ext,children);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(m,cljs.core.cst$kw$data,((function (m,vec__2025,seq__2026,first__2027,seq__2026__$1,element,properties_children,vec__2028,properties,children,component,map__2031,map__2031__$1,data,errors,explain){
return (function (p1__2024_SHARP_){
...
})()], null)),p1__2024_SHARP_);
});})(m,vec__2025,seq__2026,first__2027,seq__2026__$1,element,properties_children,vec__2028,properties,children,component,map__2031,map__2031__$1,data,errors,explain))
);
})();
var G__2033__$1 = (((component == null))?pluto.reader.errors.accumulate_errors(G__2033,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.reader.errors.error.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pluto$reader$errors_SLASH_unknown_DASH_component,element)], null)):G__2033);
if(cljs.core.seq(errors)){
return pluto.reader.errors.accumulate_errors(G__2033__$1,errors);
} else {
return G__2033__$1;
}
} else {
...
var map__2034 = (pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3 ? pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3(ctx,ext,o) : pluto.reader.blocks.parse.call(null,ctx,ext,o));
...
var m = map__2034__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2034__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2034__$1,cljs.core.cst$kw$errors);
...
var map__2036 = pluto.reader.destructuring.destructure(ps,properties);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2036__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2036__$1,cljs.core.cst$kw$errors);
...
var tag = first__2041;
var properties_children = seq__2040__$1;
var vec__2042 = pluto.reader.views.resolve_properties_children(properties_children);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2042,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2042,(1),null);
var map__2045 = (cljs.core.truth_(properties)?pluto.reader.views.inject_properties(props,properties):null);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2045__$1,cljs.core.cst$kw$data);
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,(cljs.core.truth_(data)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,data], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag], null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (vec__2039,seq__2040,first__2041,seq__2040__$1,tag,properties_children,vec__2042,props,children,map__2045,map__2045__$1,data){
return (function (p1__2038_SHARP_){
return (pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2(p1__2038_SHARP_,properties) : pluto.reader.views.hiccup_with_properties.call(null,p1__2038_SHARP_,properties));
});})(vec__2039,seq__2040,first__2041,seq__2040__$1,tag,properties_children,vec__2042,props,children,map__2045,map__2045__$1,data))
,children));
} else {
return h;
}
...
var map__2047 = pluto.reader.reference.resolve(ctx,ext,type,value);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2047__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2047__$1,cljs.core.cst$kw$errors);
if(cljs.core.truth_(data)){
if(cljs.core.fn_QMARK_(data)){
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,data], null);
} else {
var map__2049 = pluto.reader.views.parse(ctx,ext,data);
...
var m = map__2049__$1;
var data__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2049__$1,cljs.core.cst$kw$data);
var errors__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2049__$1,cljs.core.cst$kw$errors);
return pluto.reader.errors.merge_errors((cljs.core.truth_(data__$1)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,((function (map__2049,map__2049__$1,m,data__$1,errors__$1,map__2047,map__2047__$1,data,errors){
return (function (o){
return pluto.reader.views.hiccup_with_properties(data__$1,o);
});})(map__2049,map__2049__$1,m,data__$1,errors__$1,map__2047,map__2047__$1,data,errors))
