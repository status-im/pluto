...
pluto.reader.views.resolve_component = (function pluto$reader$views$resolve_component(ctx,ext,p__1346){
var vec__1347 = p__1346;
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1347,(0),null);
var o = vec__1347;
...
return cljs.core.cst$kw$data.cljs$core$IFn$_invoke$arity$1((function (){var G__1350 = ctx;
var G__1351 = ext;
var G__1352 = cljs.core.cst$kw$view;
var G__1353 = o;
return (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(G__1350,G__1351,G__1352,G__1353) : pluto.reader.types.resolve.call(null,G__1350,G__1351,G__1352,G__1353));
})());
}
} else {
return null;
...
var hierarchy__4528__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.cst$kw$hierarchy,(function (){var fexpr__1354 = cljs.core.get_global_hierarchy;
return (fexpr__1354.cljs$core$IFn$_invoke$arity$0 ? fexpr__1354.cljs$core$IFn$_invoke$arity$0() : fexpr__1354.call(null));
})());
...
return cljs.core.not((function (){var fexpr__1355 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$event,null,cljs.core.cst$kw$view,null], null), null);
return (fexpr__1355.cljs$core$IFn$_invoke$arity$1 ? fexpr__1355.cljs$core$IFn$_invoke$arity$1(type) : fexpr__1355.call(null,type));
})());
} else {
...
var map__1356 = (pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4 ? pluto.reader.types.resolve.cljs$core$IFn$_invoke$arity$4(ctx,ext,type,v) : pluto.reader.types.resolve.call(null,ctx,ext,type,v));
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1356__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1356__$1,cljs.core.cst$kw$errors);
...
var map__1358 = pluto.reader.views.resolve_property(ctx,ext,component,k,v);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1358__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1358__$1,cljs.core.cst$kw$errors);
...
pluto.reader.views.resolve_properties_children = (function pluto$reader$views$resolve_properties_children(p__1360){
var vec__1361 = p__1360;
var seq__1362 = cljs.core.seq(vec__1361);
var first__1363 = cljs.core.first(seq__1362);
var seq__1362__$1 = cljs.core.next(seq__1362);
var properties_QMARK_ = first__1363;
var children = seq__1362__$1;
...
var element = first__1367;
var properties_children = seq__1366__$1;
var vec__1368 = pluto.reader.views.resolve_properties_children(properties_children);
var properties = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1368,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1368,(1),null);
var component = pluto.reader.views.resolve_component(ctx,ext,o);
var map__1371 = (cljs.core.truth_(properties)?pluto.reader.views.resolve_component_properties(ctx,ext,element,properties):null);
...
var G__1373 = (function (){var m = pluto.reader.views.parse_hiccup_children(ctx,ext,children);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(m,cljs.core.cst$kw$data,((function (m,vec__1365,seq__1366,first__1367,seq__1366__$1,element,properties_children,vec__1368,properties,children,component,map__1371,map__1371__$1,data,errors,explain){
...
})()], null)),p1__1364_SHARP_);
});})(m,vec__1365,seq__1366,first__1367,seq__1366__$1,element,properties_children,vec__1368,properties,children,component,map__1371,map__1371__$1,data,errors,explain))
);
})();
var G__1373__$1 = (((component == null))?pluto.reader.errors.accumulate_errors(G__1373,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.reader.errors.error.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pluto$reader$errors_SLASH_unknown_DASH_component,element)], null)):G__1373);
if(cljs.core.seq(errors)){
return pluto.reader.errors.accumulate_errors(G__1373__$1,errors);
} else {
return G__1373__$1;
}
} else {
...
var component = first__1378;
var first__1378__$1 = cljs.core.first(seq__1377__$1);
var seq__1377__$2 = cljs.core.next(seq__1377__$1);
var properties = first__1378__$1;
var children = seq__1377__$2;
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (vec__1376,seq__1377,first__1378,seq__1377__$1,component,first__1378__$1,seq__1377__$2,properties,children){
return (function (p1__1374_SHARP_,p2__1375_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,p1__1374_SHARP_,(pluto.reader.views.unresolved_properties.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.views.unresolved_properties.cljs$core$IFn$_invoke$arity$2(acc,p2__1375_SHARP_) : pluto.reader.views.unresolved_properties.call(null,acc,p2__1375_SHARP_)));
});})(vec__1376,seq__1377,first__1378,seq__1377__$1,component,first__1378__$1,seq__1377__$2,properties,children))
,acc,children);
} else {
return acc;
...
var map__1379 = (pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3 ? pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3(ctx,ext,o) : pluto.reader.blocks.parse.call(null,ctx,ext,o));
...
var m = map__1379__$1;
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1379__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1379__$1,cljs.core.cst$kw$errors);
...
var vec__1382 = h;
var seq__1383 = cljs.core.seq(vec__1382);
var first__1384 = cljs.core.first(seq__1383);
var seq__1383__$1 = cljs.core.next(seq__1383);
var tag = first__1384;
var properties_children = seq__1383__$1;
var vec__1385 = pluto.reader.views.resolve_properties_children(properties_children);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1385,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__1385,(1),null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,(cljs.core.truth_(props__$1)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,props__$1], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag], null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (vec__1382,seq__1383,first__1384,seq__1383__$1,tag,properties_children,vec__1385,props,children,props__$1){
return (function (p1__1381_SHARP_){
return (pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2(p1__1381_SHARP_,properties) : pluto.reader.views.hiccup_with_properties.call(null,p1__1381_SHARP_,properties));
});})(vec__1382,seq__1383,first__1384,seq__1383__$1,tag,properties_children,vec__1385,props,children,props__$1))
,children));
} else {
return h;
}
...
var map__1388 = pluto.reader.reference.resolve(ctx,ext,type,value);
...
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1388__$1,cljs.core.cst$kw$data);
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1388__$1,cljs.core.cst$kw$errors);
if(cljs.core.truth_(data)){
if(cljs.core.fn_QMARK_(data)){
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,data], null);
} else {
var map__1390 = pluto.reader.views.parse(ctx,ext,data);
...
var m = map__1390__$1;
var data__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1390__$1,cljs.core.cst$kw$data);
var errors__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__1390__$1,cljs.core.cst$kw$errors);
return pluto.reader.errors.merge_errors((cljs.core.truth_(data__$1)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,((function (map__1390,map__1390__$1,m,data__$1,errors__$1,map__1388,map__1388__$1,data,errors){
return (function (o){
return pluto.reader.views.hiccup_with_properties(data__$1,o);
});})(map__1390,map__1390__$1,m,data__$1,errors__$1,map__1388,map__1388__$1,data,errors))
