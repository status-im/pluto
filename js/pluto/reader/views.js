...
var map__2150 = pluto.reader.views.resolve_property(ctx,ext,component,k,v);
...
pluto.reader.views.resolve_properties_children = (function pluto$reader$views$resolve_properties_children(p__2152){
...
var properties_QMARK_ = first__2155;
var children = seq__2154__$1;
...
var vec__2157 = o;
var seq__2158 = cljs.core.seq(vec__2157);
var first__2159 = cljs.core.first(seq__2158);
var seq__2158__$1 = cljs.core.next(seq__2158);
var element = first__2159;
var properties_children = seq__2158__$1;
var vec__2160 = pluto.reader.views.resolve_properties_children(properties_children);
var properties = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2160,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2160,(1),null);
var component = pluto.reader.views.resolve_component(ctx,element);
var map__2163 = (cljs.core.truth_(properties)?pluto.reader.views.resolve_component_properties(ctx,ext,element,properties):null);
...
var G__2165 = (function (){var m = pluto.reader.views.parse_hiccup_children(ctx,ext,children);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(m,cljs.core.cst$kw$data,((function (m,vec__2157,seq__2158,first__2159,seq__2158__$1,element,properties_children,vec__2160,properties,children,component,map__2163,map__2163__$1,data,errors,explain){
...
})()], null)),p1__2156_SHARP_);
});})(m,vec__2157,seq__2158,first__2159,seq__2158__$1,element,properties_children,vec__2160,properties,children,component,map__2163,map__2163__$1,data,errors,explain))
);
})();
var G__2165__$1 = (((component == null))?pluto.reader.errors.accumulate_errors(G__2165,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [pluto.reader.errors.error.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$pluto$reader$errors_SLASH_unknown_DASH_component,element)], null)):G__2165);
if(cljs.core.seq(errors)){
return pluto.reader.errors.accumulate_errors(G__2165__$1,errors);
} else {
return G__2165__$1;
}
} else {
...
var map__2166 = (pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3 ? pluto.reader.blocks.parse.cljs$core$IFn$_invoke$arity$3(ctx,ext,o) : pluto.reader.blocks.parse.call(null,ctx,ext,o));
...
var map__2168 = pluto.reader.destructuring.destructure(ps,properties);
...
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2174,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2174,(1),null);
var map__2177 = (cljs.core.truth_(properties)?pluto.reader.views.inject_properties(props,properties):null);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,(cljs.core.truth_(data)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,data], null):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag], null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (vec__2171,seq__2172,first__2173,seq__2172__$1,tag,properties_children,vec__2174,props,children,map__2177,map__2177__$1,data){
return (function (p1__2170_SHARP_){
return (pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2 ? pluto.reader.views.hiccup_with_properties.cljs$core$IFn$_invoke$arity$2(p1__2170_SHARP_,properties) : pluto.reader.views.hiccup_with_properties.call(null,p1__2170_SHARP_,properties));
});})(vec__2171,seq__2172,first__2173,seq__2172__$1,tag,properties_children,vec__2174,props,children,map__2177,map__2177__$1,data))
,children));
} else {
return h;
}
...
var map__2179 = pluto.reader.reference.resolve(ctx,ext,type,value);
...
var errors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2179__$1,cljs.core.cst$kw$errors);
if(cljs.core.truth_(data)){
if(cljs.core.fn_QMARK_(data)){
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,data], null);
} else {
var map__2181 = pluto.reader.views.parse(ctx,ext,data);
...
var m = map__2181__$1;
var data__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2181__$1,cljs.core.cst$kw$data);
var errors__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2181__$1,cljs.core.cst$kw$errors);
return pluto.reader.errors.merge_errors((cljs.core.truth_(data__$1)?new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$data,((function (map__2181,map__2181__$1,m,data__$1,errors__$1,map__2179,map__2179__$1,data,errors){
return (function (o){
return pluto.reader.views.hiccup_with_properties(data__$1,o);
});})(map__2181,map__2181__$1,m,data__$1,errors__$1,map__2179,map__2179__$1,data,errors))
