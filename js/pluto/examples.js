...
var G__2078__delegate = function (args){
...
var G__2078 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__2079__i = 0, G__2079__a = new Array(arguments.length -  0);
while (G__2079__i < G__2079__a.length) {G__2079__a[G__2079__i] = arguments[G__2079__i + 0]; ++G__2079__i;}
  args = new cljs.core.IndexedSeq(G__2079__a,0,null);
} 
return G__2078__delegate.call(this,args);};
G__2078.cljs$lang$maxFixedArity = 0;
G__2078.cljs$lang$applyTo = (function (arglist__2080){
var args = cljs.core.seq(arglist__2080);
return G__2078__delegate(args);
});
G__2078.cljs$core$IFn$_invoke$arity$variadic = G__2078__delegate;
return G__2078;
})()
], null));
...
var G__2081 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$random,(cljs.core.rand_int((2)) === (0))], null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$random,(function (db,p__2082){
var vec__2083 = p__2082;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2083,(0),null);
var b = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2083,(1),null);
...
var G__2086_2088 = cljs.core.cst$kw$pluto$examples_SLASH_alert;
var G__2087_2089 = ((function (G__2086_2088){
return (function (value){
return alert(value);
});})(G__2086_2088))
;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__2086_2088,G__2087_2089) : re_frame.core.reg_fx.call(null,G__2086_2088,G__2087_2089));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(cljs.core.cst$kw$alert,(function (cofx,p__2090){
var vec__2091 = p__2090;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2091,(0),null);
var map__2094 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__2091,(1),null);
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2094__$1,cljs.core.cst$kw$value);
return new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$pluto$examples_SLASH_alert,value], null);
}));
var G__2096_2098 = cljs.core.cst$kw$random_DASH_boolean;
var G__2097_2099 = cljs.core.cst$kw$random;
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__2096_2098,G__2097_2099) : re_frame.core.reg_sub.call(null,G__2096_2098,G__2097_2099));
pluto.examples.render = (function pluto$examples$render(h,el){
return reagent.core.render.cljs$core$IFn$_invoke$arity$2((function (){var G__2100 = new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$name,"Test Extension"], null);
return (h.cljs$core$IFn$_invoke$arity$1 ? h.cljs$core$IFn$_invoke$arity$1(G__2100) : h.call(null,G__2100));
})(),el);
});
pluto.examples.errors_list = (function pluto$examples$errors_list(v){
return (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$div,"Errors"], null),cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$ul], null),(function (){var iter__4324__auto__ = (function pluto$examples$errors_list_$_iter__2101(s__2102){
return (new cljs.core.LazySeq(null,(function (){
var s__2102__$1 = s__2102;
while(true){
var temp__5457__auto__ = cljs.core.seq(s__2102__$1);
if(temp__5457__auto__){
var s__2102__$2 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_(s__2102__$2)){
var c__4322__auto__ = cljs.core.chunk_first(s__2102__$2);
var size__4323__auto__ = cljs.core.count(c__4322__auto__);
var b__2104 = cljs.core.chunk_buffer(size__4323__auto__);
if((function (){var i__2103 = (0);
while(true){
if((i__2103 < size__4323__auto__)){
var map__2105 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4322__auto__,i__2103);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__2104),pluto$examples$errors_list_$_iter__2101(cljs.core.chunk_rest(s__2102__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__2104),null);
}
} else {
var map__2107 = cljs.core.first(s__2102__$2);
...
var m = map__2107__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2107__$1,cljs.core.cst$kw$type);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$span,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$b,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(type)].join('')], null),cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(m,cljs.core.cst$kw$type)], 0))], null)], null),pluto$examples$errors_list_$_iter__2101(cljs.core.rest(s__2102__$2)));
}
} else {
return null;
}
...
if((typeof pluto !== 'undefined') && (typeof pluto.examples !== 'undefined') && (typeof pluto.examples.t_pluto$examples2110 !== 'undefined')){
} else {
...
*/
pluto.examples.t_pluto$examples2110 = (function (meta2111){
this.meta2111 = meta2111;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
pluto.examples.t_pluto$examples2110.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_2112,meta2111__$1){
var self__ = this;
var _2112__$1 = this;
return (new pluto.examples.t_pluto$examples2110(meta2111__$1));
});

pluto.examples.t_pluto$examples2110.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_2112){
var self__ = this;
var _2112__$1 = this;
return self__.meta2111;
});

pluto.examples.t_pluto$examples2110.prototype.pluto$reader$hooks$Hook$ = cljs.core.PROTOCOL_SENTINEL;

pluto.examples.t_pluto$examples2110.prototype.pluto$reader$hooks$Hook$hook_in$arity$4 = (function (_,id,p__2113,cofx){
var self__ = this;
...
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2114__$1,cljs.core.cst$kw$description);
var scope = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2114__$1,cljs.core.cst$kw$scope);
var parameters = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2114__$1,cljs.core.cst$kw$parameters);
var preview = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2114__$1,cljs.core.cst$kw$preview);
var short_preview = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2114__$1,cljs.core.cst$kw$short_DASH_preview);
var ___$1 = this;
return null;
});

pluto.examples.t_pluto$examples2110.prototype.pluto$reader$hooks$Hook$unhook$arity$4 = (function (_,id,p__2116,p__2117){
var self__ = this;
var map__2118 = p__2116;
...
var scope = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2118__$1,cljs.core.cst$kw$scope);
...
var cofx = map__2119__$1;
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2119__$1,cljs.core.cst$kw$db);
var ___$1 = this;
return null;
});

pluto.examples.t_pluto$examples2110.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$meta2111], null);
});

pluto.examples.t_pluto$examples2110.cljs$lang$type = true;

pluto.examples.t_pluto$examples2110.cljs$lang$ctorStr = "pluto.examples/t_pluto$examples2110";

pluto.examples.t_pluto$examples2110.cljs$lang$ctorPrWriter = (function (this__4192__auto__,writer__4193__auto__,opt__4194__auto__){
return cljs.core._write(writer__4193__auto__,"pluto.examples/t_pluto$examples2110");
});

/**
 * Positional factory function for pluto.examples/t_pluto$examples2110.
 */
pluto.examples.__GT_t_pluto$examples2110 = (function pluto$examples$__GT_t_pluto$examples2110(meta2111){
return (new pluto.examples.t_pluto$examples2110(meta2111));
});

}

return (new pluto.examples.t_pluto$examples2110(cljs.core.PersistentArrayMap.EMPTY));
})()
;
...
var map__2122 = pluto.examples.parse(m);
...
var map__2124 = pluto.reader.read(cljs.core.cst$kw$content.cljs$core$IFn$_invoke$arity$1(cljs.core.first(o)));
...
pluto.examples.render_result = (function pluto$examples$render_result(p__2126,el,el_errors){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2127__$1,cljs.core.cst$kw$type);
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__2127__$1,cljs.core.cst$kw$value);
var G__2129 = type;
var G__2129__$1 = (((G__2129 instanceof cljs.core.Keyword))?G__2129.fqn:null);
switch (G__2129__$1) {
case "error":
...
return pluto.storages.fetch(s,(function (p1__2131_SHARP_){
return pluto.examples.render_result(p1__2131_SHARP_,el,el_errors);
}));
});
