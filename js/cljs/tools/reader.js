...
var G__1942 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__1942;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__1943 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__1943,ch);
...
if(("\\" === ch__$1)){
var ch_1944__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_1944__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_1944__$2);
} else {
}

var G__1945 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__1945;
continue;
}
}
...
var vec__1953 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__1953,(0),null);
var start_column = cljs.core.nth.call(null,vec__1953,(1),null);
...
var G__1956 = cljs.core.conj_BANG_.call(null,a,form);
a = G__1956;
continue;
}
}
...
var _STAR_read_delim_STAR_1957 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_1957;
}});
/**
...
var _STAR_suppress_read_STAR_2016 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_2016;
}});
...
var G__2017 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__2017,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__2017,rdr,first_line);
...
var G__2021 = matched;
var G__2022 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__2021;
finished = G__2022;
continue;
} else {
...
var _STAR_suppress_read_STAR_2023 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_2023;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env2024 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__2025 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__2025,"(");
...
var G__2026 = (i + (1));
var G__2027 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3936__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3936__auto__)){
return or__3936__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env2024;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__2028 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__2028);
...
var G__2029 = cljs.core.next.call(null,s__$1);
var G__2030 = ret;
s__$1 = G__2029;
r = G__2030;
continue;
...
var G__2031 = cljs.core.next.call(null,s);
var G__2032 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__2031;
key_vals = G__2032;
continue;
} else {
...
var gensym_env2036 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env2036;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__2037 = token;
var G__2037__$1 = (((G__2037 == null))?null:cljs.core.subs.call(null,G__2037,(1)));
var G__2037__$2 = (((G__2037__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__2037__$1));
var G__2037__$3 = (((G__2037__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__2037__$2));
var G__2037__$4 = (((G__2037__$3 == null))?null:cljs.core.symbol.call(null,G__2037__$3));
if((G__2037__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__2037__$4);
}
})():(function (){var G__2038 = token;
var G__2038__$1 = (((G__2038 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__2038));
if((G__2038__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__2038__$1);
}
})()
));
if(cljs.core.truth_(temp__5455__auto__)){
...
}catch (e2045){if((e2045 instanceof Error)){
var e = e2045;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__2049,reader){
...
var eof = cljs.core.get.call(null,map__2050__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
